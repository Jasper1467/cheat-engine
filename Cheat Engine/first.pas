...
initialization
  ...
  begin
    ...
    if r.OpenKey('\Software\'+{$ifdef altname}'Runtime Modifier'{$else}'ZBEXgogrYe'{$endif},false) then
    begin
    ...
    begin
      ...
      if r.OpenKey('\Software\'+{$ifdef altname}'Runtime Modifier'{$else}'ZBEXgogrYe'{$endif},true) then
      begin
        //I do have access
